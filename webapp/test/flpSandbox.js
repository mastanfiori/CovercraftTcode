		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Production order Confirmation Process",
									"targetURL": "#comcovercraftNTTDataProdOrdCnfrmPrcscovercraftpp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcovercraftNTTDataProdOrdCnfrmPrcscovercraftpp-display": {
								"semanticObject": "comcovercraftNTTDataProdOrdCnfrmPrcscovercraftpp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.covercraft.NTTData.ProdOrdCnfrmPrcs.covercraftpp",
									"url": sap.ui.require.toUrl("com/covercraft/NTTData/ProdOrdCnfrmPrcs/covercraftpp")
								}
							}
						}
					}
